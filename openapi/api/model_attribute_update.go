...
func (v NullableAttributeUpdate) Get() *AttributeUpdate {
	return v.value
}

func (v *NullableAttributeUpdate) Set(val *AttributeUpdate) {
	v.value = val
	v.isSet = true
}
...
func NewNullableAttributeUpdate(val *AttributeUpdate) *NullableAttributeUpdate {
	return &NullableAttributeUpdate{value: val, isSet: true}
}
