...
type NullableContractUpdatedResponse struct {
	value *ContractUpdatedResponse
	isSet bool
}

func (v NullableContractUpdatedResponse) Get() *ContractUpdatedResponse {
	return v.value
}

func (v *NullableContractUpdatedResponse) Set(val *ContractUpdatedResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableContractUpdatedResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableContractUpdatedResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContractUpdatedResponse(val *ContractUpdatedResponse) *NullableContractUpdatedResponse {
	return &NullableContractUpdatedResponse{value: val, isSet: true}
}
