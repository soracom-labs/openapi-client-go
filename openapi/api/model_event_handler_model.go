...
type NullableEventHandlerModel struct {
	value *EventHandlerModel
	isSet bool
}

func (v NullableEventHandlerModel) Get() *EventHandlerModel {
	return v.value
}

func (v *NullableEventHandlerModel) Set(val *EventHandlerModel) {
	v.value = val
	v.isSet = true
}
...
func NewNullableEventHandlerModel(val *EventHandlerModel) *NullableEventHandlerModel {
	return &NullableEventHandlerModel{value: val, isSet: true}
}
