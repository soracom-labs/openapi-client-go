...
func NewFunnelAppressoDataSpiderDestination() *FunnelAppressoDataSpiderDestination {
	this := FunnelAppressoDataSpiderDestination{}
	return &this
}
...
type NullableFunnelAppressoDataSpiderDestination struct {
	value *FunnelAppressoDataSpiderDestination
	isSet bool
}

func (v NullableFunnelAppressoDataSpiderDestination) Get() *FunnelAppressoDataSpiderDestination {
	return v.value
}

func (v *NullableFunnelAppressoDataSpiderDestination) Set(val *FunnelAppressoDataSpiderDestination) {
	v.value = val
	v.isSet = true
}

func (v NullableFunnelAppressoDataSpiderDestination) IsSet() bool {
	return v.isSet
}

func (v *NullableFunnelAppressoDataSpiderDestination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFunnelAppressoDataSpiderDestination(val *FunnelAppressoDataSpiderDestination) *NullableFunnelAppressoDataSpiderDestination {
	return &NullableFunnelAppressoDataSpiderDestination{value: val, isSet: true}
}

func (v NullableFunnelAppressoDataSpiderDestination) MarshalJSON() ([]byte, error) {
