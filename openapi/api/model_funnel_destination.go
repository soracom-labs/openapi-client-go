...
func (v NullableFunnelDestination) Get() *FunnelDestination {
	return v.value
}

func (v *NullableFunnelDestination) Set(val *FunnelDestination) {
	v.value = val
	v.isSet = true
}
...
func NewNullableFunnelDestination(val *FunnelDestination) *NullableFunnelDestination {
	return &NullableFunnelDestination{value: val, isSet: true}
}
