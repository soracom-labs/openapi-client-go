...
func NewFunnelKiiThingifDestination() *FunnelKiiThingifDestination {
	this := FunnelKiiThingifDestination{}
	return &this
}
...
type NullableFunnelKiiThingifDestination struct {
	value *FunnelKiiThingifDestination
	isSet bool
}

func (v NullableFunnelKiiThingifDestination) Get() *FunnelKiiThingifDestination {
	return v.value
}

func (v *NullableFunnelKiiThingifDestination) Set(val *FunnelKiiThingifDestination) {
	v.value = val
	v.isSet = true
}

func (v NullableFunnelKiiThingifDestination) IsSet() bool {
	return v.isSet
}

func (v *NullableFunnelKiiThingifDestination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFunnelKiiThingifDestination(val *FunnelKiiThingifDestination) *NullableFunnelKiiThingifDestination {
	return &NullableFunnelKiiThingifDestination{value: val, isSet: true}
}
