...
func NewFunnelWingarcMotionboardDestination() *FunnelWingarcMotionboardDestination {
	this := FunnelWingarcMotionboardDestination{}
	return &this
}
...
type NullableFunnelWingarcMotionboardDestination struct {
	value *FunnelWingarcMotionboardDestination
	isSet bool
}

func (v NullableFunnelWingarcMotionboardDestination) Get() *FunnelWingarcMotionboardDestination {
	return v.value
}

func (v *NullableFunnelWingarcMotionboardDestination) Set(val *FunnelWingarcMotionboardDestination) {
	v.value = val
	v.isSet = true
}

func (v NullableFunnelWingarcMotionboardDestination) IsSet() bool {
	return v.isSet
}

func (v *NullableFunnelWingarcMotionboardDestination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFunnelWingarcMotionboardDestination(val *FunnelWingarcMotionboardDestination) *NullableFunnelWingarcMotionboardDestination {
	return &NullableFunnelWingarcMotionboardDestination{value: val, isSet: true}
}

func (v NullableFunnelWingarcMotionboardDestination) MarshalJSON() ([]byte, error) {
